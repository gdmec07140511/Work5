package c07140511xin.gdmec.edu.cn.work5;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null) {
            ...
            Bundle localBoundle = getIntent().getExtras();
            if (localBoundle != null){
                String t_path = localBoundle.getString("path");
        ...
        try{
            if (!mPath.equals("")){
                ...
                AssetFileDescriptor afd = this.getResources().openRawResourceFd(R.raw.lala);
        ...
        ff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (player.isPlaying()){
                    int currenPostion = player.getCurrentPosition();
                    if (currenPostion+10000<player.getDuration()){
                        player.seekTo(currenPostion+10000);
                    }
                }
            }
        });
